...
💰 El acceso `no tiene costo` pero requiere [registrarse](https://forms.gle/YLkTwczr4zgpbVUr8). A fin de organizar un evento del agrado de todos, contribuciones voluntarias de `50,000 | 100,000 | 200,000` COP son bienvenidas e incluyen stickers 🖼️, pizza 🍕 y una bebida 🍹.
